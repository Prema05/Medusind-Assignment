    ...
    <form id="form1" runat="server">
        <div>
            <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                ...
                <asp:ListItem Text="Avacado" Value="Avacado"></asp:ListItem>
                <asp:ListItem Text="BlackBerry" Value=""></asp:ListItem>
                <asp:ListItem Text="Cherry" Value="Cherry"></asp:ListItem>
                <asp:ListItem Text="DragonFruit" Value="DragonFruit"></asp:ListItem>
